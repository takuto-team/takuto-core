...
//! on the legacy `/api/workflows/*` path with an `X-Takuto-Deprecation`
...
const DEPRECATION_HEADER: HeaderName = HeaderName::from_static("x-takuto-deprecation");
