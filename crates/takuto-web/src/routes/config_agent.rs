...
pub async fn put_agent_config(
    ...
    if let Some(w) = takuto_core::docker_hooks::check_config_dir_writable(&cfg_state.config_path) {
            ...
            .load(std::sync::atomic::Ordering::Acquire)
    {
        refreshed
            .warnings
            .push(takuto_core::docker_hooks::StructuredWarning::info(
